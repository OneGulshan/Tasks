...
namespace Tasks
{
    public class EmployeeCreate : PageModel
    {
        ...
        public EmployeeCreate(DataContext context)
        {
            _context = context;
        }
        ...
        {
            _context.Employee.Add(NewEmployee);//This is the form field navigation property for mapping with db and inserting an record in db
